...
alsa_monitor.rules = {
  ...
  },
  {
    matches = {
      {
        { "node.name", "matches", "alsa_output.platform-3f902000.hdmi.*" },
      },    
    },
    apply_properties = {
  ...
  },
  {
    matches = {
      {
        { "node.name", "matches", "alsa_output.platform-soc_sound.*" },
      },
    },
    apply_properties = {
  ...
  },
  {
    matches = {
      {
        { "node.name", "matches", "alsa_output.platform-bcm2835_audio.*" },
      },
    },
    apply_properties = {
